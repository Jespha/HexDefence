...
public static class AnimationCoroutine
{
	...
	)
	{
		...
		while (_time < _duration)
		{
			...
			rectTransform.anchoredPosition = Vector2LerpUnClamped(
				_startPosition,
				targetPosition,
				t
			);
	...
	public static IEnumerator IdleFloatRotate(
		RectTransform rectTransform,
		float speed,
		float maxRotation,
		AnimationCurve curve
	...
	public static IEnumerator AnimatePositionCoroutine(
	...
	)
	{
		...
		{
			Vector3 newPosition = Vector3LerpUnClamped(
				targetPosition,
				originalPosition,
				_curve.Evaluate(time / _duration)
			);
	...
	public static IEnumerator AnimatedVector2ToZero(
	...
	)
	{
		...
		while (time < duration)
		{
			...
			selectedHexCell.CurrentOffset = Vector2LerpUnClamped(
				startValue,
				Vector2.zero,
				_curve.Evaluate(time / _duration)
			);
	...
	public static Vector3 WorldToLocalUISpace(
		Canvas parentCanvas,
		Vector3 worldPos,
		RectTransform rectTransform
	)
