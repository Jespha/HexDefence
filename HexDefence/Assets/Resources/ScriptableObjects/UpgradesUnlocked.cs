...
[CreateAssetMenu(
	fileName = "CurrentUpgradesPossibilities",
	menuName = "ScriptableObjects/CurrentUpgradesPossibilities",
	order = 22
)]
public class UnlockedUpgrades : ScriptableObject
{
	/// <summary>
	...
	public void InitializeCurrentUnlockedUpgrades()
	{
	...
	public void UpdateCurrentUnlockedUpgrades()
	{
		ClearAllPossibleUpgrades();
		foreach (Upgrade upgrade in Resources.LoadAll<Upgrade>("ScriptableObjects/Upgrade"))
		{
